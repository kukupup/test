...
public class PayController {
    ...
    private final String RETURN_URL = "http://5828-180-106-50-18.ngrok.io/pay/returnUrlCustom/1";
    ...
    @RequestMapping("/aliapyCustom")
    public void alipay(HttpServletResponse httpResponse,HttpServletRequest httpServletRequest
                       ) throws IOException {
        //判断

       String  orderId1=httpServletRequest.getParameter("orderId");
        String payType1=httpServletRequest.getParameter("payType");
          Long orderId=Long.valueOf(orderId1);
       Integer payType= Integer.parseInt(payType1);
        ...
        long betweenSecond=DateUtil.between(createTime,now,DateUnit.SECOND);
        if(between>overtime && betweenSecond>betweenSecond){
    ...
    @RequestMapping(value = "/returnUrlCustom/{paytype}", method = RequestMethod.GET)
    public String returnUrl(
            @PathVariable(value = "paytype") Integer paytype,
