...
import com.tulingxueyuan.mall.controller.testPayController;
...
//
    ...
    public CommonResult tradeQrCode(Long orderId, Integer payType) throws IOException {
        // 订单信息
      ...
      // 三目表达式，如果为true为前面的值，否则为后面的值，这里面是调用哪个方法
 ...
 //自定义改动了方法
          ...
          qrCodePath = payType==1?aliPayTrade(detail):weichatPayTrade(detail);
