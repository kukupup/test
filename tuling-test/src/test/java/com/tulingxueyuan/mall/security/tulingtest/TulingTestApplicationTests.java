...
class TulingTestApplicationTests {
    ...
    void uploadOSS() throws FileNotFoundException {
        ...
        // 上传文件流。
        InputStream inputStream = new FileInputStream("C:\\Users\\adminbaba\\Desktop\\ideabg2.jpg");
        //存储空间名
        ossClient.putObject("tuling-zm", dir+"ideabg2.jpg"+UUID.randomUUID().toString(), inputStream);
